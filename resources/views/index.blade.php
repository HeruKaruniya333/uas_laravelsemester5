...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	var marker1 = L.marker([-8.714278,116.273766]).addTo(mymap)
		.bindPopup("<b>Ini adalah Titik</b><br />Dusun banar.").openPopup();
	var popup = L.popup();
		...
		var popupContent = "<p>Selamat datang di, Dususn banar!</p>";
	...
	// TAMAN BERMAIN
	//##############################################//
	var sekolah = L.marker([-8.7045539, 116.2712998],{icon: sekolahIcon}).bindPopup("dusun bnar <img src='img/kantor desa pengadang.jpg' alt='j3mart' width='350px'/>");
